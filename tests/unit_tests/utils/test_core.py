...
def test_parse_ssl_cert_returns_certificate_type() -> None:
    """Verify that cryptography types are properly resolved (not ignored by mypy)."""
    ...
    result = parse_ssl_cert(ssl_certificate)
